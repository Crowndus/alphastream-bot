...
export const STRATEGY_1_3_2_6 = (): TDescriptionItem[] => [
    {
        type: 'subtitle',
        content: [`${localize('Exploring the')} 1-3-2-6 ${localize('strategy in Alphastream Bot')}`],
        expanded: true,
    ...
    },
    {
        type: 'text',
        content: [
            `${localize('These are the trade parameters used in Alphastream Bot with')} 1-3-2-6 ${localize('strategy.')}`,
        ],
    },
    {
        type: 'text',
