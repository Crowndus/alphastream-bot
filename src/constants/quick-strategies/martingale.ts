...
export const MARTINGALE = (): TDescriptionItem[] => [
    {
        type: 'subtitle',
        content: [`${localize('Exploring the')} Martingale ${localize('strategy in Alphastream Bot')}`],
        expanded: true,
    ...
    },
    {
        type: 'text',
        content: [
            `${localize('These are the trade parameters used in Alphastream Bot with')} Martingale ${localize('strategy.')}`,
        ],
    },
    {
        type: 'text',
    ...
    },
    {
        ...
        content: [
            ...
            localize(
                '3. If the first trade ends in a loss, Alphastream Bot will automatically double your stake for the next trade to 2 USD. Alphastream Bot will continue to double the stake after every losing trade.'
            ),
            localize(
