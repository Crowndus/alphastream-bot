...
export const D_ALEMBERT = (): TDescriptionItem[] => [
    {
        type: 'subtitle',
        content: [localize('Exploring the D’Alembert strategy in Alphastream Bot')],
        expanded: true,
    ...
    {
        type: 'text',
        content: [localize('These are the trade parameters used for D’Alembert strategy in Alphastream Bot.')],
    },
    {
        type: 'text',
    ...
    },
    {
        ...
        content: [
            ...
            localize(
                '4. If the second trade results in a loss, the Alphastream Bot will automatically increase your stake for the next trade by 2 USD. Alphastream Bot will continue to add 2 USD to the previous round’s stake after every losing trade. See A2.'
            ),
            localize(
